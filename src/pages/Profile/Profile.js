...
import { TOKEN, GROUPID, USER_LOGIN } from '../../util/settings/config';
import { useDispatch, useSelector } from 'react-redux';
import { capNhatThongTinProfileAction, layThongTinNguoiDungAction,  } from '../../redux/actions/QuanLyNguoiDungAction';
        ...
        <div className="container">
            <Tabs tabBarExtraContent={operations} defaultActiveKey="1" onChange={callback}>
                <TabPane tab="Thông tin cá nhân" key="1">
                    <TabProfile {...props} thongTinNguoiDungDatVe={thongTinNguoiDung} />
                </TabPane>
                <TabPane tab="Lịch sử đặt vé" key="2">
                    <TabLichSuDatVe {...props} thongTinDatVe={thongTinNguoiDung.thongTinDatVe} />
                </TabPane>
            </Tabs>
        </div>
    )
