              ...
              <div className="grid grid-cols-12">
                  <div className="pb-6 col-span-full md:pb-0 md:col-span-6">
                      <a rel="noopener noreferrer" href="#" className="flex justify-center space-x-3 md:justify-start">
                          <div className=" text-white lex items-center justify-center w-12 h-12 rounded-full dark:bg-violet-400">
                          ...
                          <span className="self-center text-2xl font-semibold">CINEMA</span>
                      </a>
                  </div>
                  <div className="col-span-6 text-center md:text-left md:col-span-3">
                      <p className="pb-1 text-lg font-medium">cinema</p>
                      <ul>
                          <li>
                              <a rel="noopener noreferrer" href="#" className="hover:dark:text-violet-400 text-white">
                              <img src="http://movieapi.cyberlearn.vn/hinhanh/bhd-star-cineplex.png" className="rounded-full" width="50"/>
                              </a>
                          </li>
                          <li>
                          <a rel="noopener noreferrer" href="#" className="hover:dark:text-violet-400 text-white">
                          <img src="http://movieapi.cyberlearn.vn/hinhanh/cgv.png" className="rounded-full" width="50"/>
                          </a>
                          </li>
                          <li>
                              <a rel="noopener noreferrer" href="#" className="hover:dark:text-violet-400 text-white">
                              <img src="http://movieapi.cyberlearn.vn/hinhanh/cinestar.png" className="rounded-full" width="50"/>
                                </a>
                          </li>
                          <li>
                              <a rel="noopener noreferrer" href="#" className="hover:dark:text-violet-400 text-white">
                              <img src="http://movieapi.cyberlearn.vn/hinhanh/galaxy-cinema.png" className="rounded-full" width="50"/>
                              </a>
                          </li>
                          <li>
                              <a rel="noopener noreferrer" href="#" className="hover:dark:text-violet-400 text-white">
                              <img src="http://movieapi.cyberlearn.vn/hinhanh/lotte-cinema.png" className="rounded-full" width="50"/>
                              </a>
                          </li>
                      </ul>
                  </div>
              ...
              <div className="grid justify-center pt-6 lg:justify-between">
                  <div className="flex flex-col self-center text-sm text-center md:block lg:col-start-1 md:space-x-6">
                      ...
                      <a rel="noopener noreferrer" href="#">
                          <span>duydan272000@gmail.com</span>
                      </a>
